...
```
1. Elastic Load Balancing (ELB) is an AWS service that automatically distributes incoming application traffic across multiple
   backend targets such as EC2 instances.
...
Step 1: Create VPC (If not already created)
 ...
 5. Update Route Table → `0.0.0.0/0` → Internet Gateway
...
Step 2: Launch EC2 Instances
 ...
 8. Add script
   ...
   echo "<h1>Welcome to Apache Server from $(hostname)</h1>" > /var/www/html/index.html
   systemctl restart apache2
   systemctl enable apache2
 9. Launch 2 instances (EC2-1, EC2-2)
